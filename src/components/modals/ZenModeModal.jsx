    ...
    return (
        <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col animate-in fade-in duration-300">
            ...
            <div className="flex-grow relative overflow-y-auto overflow-x-hidden custom-scrollbar">
                ...
                {currentSlide === 0 && (
                    <div className="min-h-full flex flex-col items-center justify-center p-8 pb-20">
                        <div className="text-center space-y-8 max-w-5xl animate-in zoom-in-95 fade-in duration-500">
                            ...
                            <h1
                                className="text-5xl md:text-9xl font-black uppercase tracking-tighter leading-none break-words"
                                style={{ color: hexColor, textShadow: `0 0 100px ${hexColor}40` }}
                            >
                                {clase.curso}
                            </h1>
                            <div className="text-xl md:text-2xl text-slate-400 font-mono mt-12 bg-white/5 inline-block px-6 py-3 md:px-8 md:py-4 rounded-2xl">
                ...
                {currentSlide === 1 && (
                    <div className="min-h-full flex flex-col items-center justify-center p-8 pb-24">
                        <div className="max-w-6xl w-full animate-in slide-in-from-right-10 fade-in duration-500 text-center md:text-left">
                            <div className="flex flex-col md:flex-row items-center gap-4 mb-8 md:mb-12 opacity-80 justify-center md:justify-start">
                                <Target size={48} className="text-indigo-400" />
                                <h3 className="text-2xl md:text-3xl font-bold text-indigo-200 uppercase tracking-widest text-center">Objetivo de la Clase</h3>
                            </div>
                            <p className="text-2xl md:text-6xl font-medium text-white leading-tight">
                ...
                {currentSlide === 2 && (
                    <div className="min-h-full flex flex-col items-center justify-center p-4 py-24 md:p-8">
                        <div className="w-full max-w-7xl flex flex-col justify-center animate-in slide-in-from-bottom-10 fade-in duration-500">
                            <h3 className="text-2xl md:text-3xl font-bold text-slate-500 uppercase tracking-widest mb-12 text-center">Momentos de la Clase</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                                ...
                                {/* Inicio */}
                                <div className="group">
                                    <div className="w-14 h-14 bg-slate-900 border-4 border-emerald-500 rounded-full flex items-center justify-center mb-6 z-10 relative shadow-[0_0_30px_rgba(16,185,129,0.4)] mx-auto">
                                        <Play size={24} className="text-white ml-1" />
                                    </div>
                                    <div className="bg-slate-900/60 p-6 rounded-2xl border border-emerald-500/30 hover:bg-slate-800/80 transition-all h-auto md:h-[400px] overflow-y-visible md:overflow-y-auto custom-scrollbar">
                                        <h4 className="text-xl font-bold text-emerald-400 mb-4 uppercase text-center md:text-left">Inicio</h4>
                                ...
                                <div className="group md:-mt-8"> {/* Staggered effect */}
                                    <div className="w-14 h-14 bg-slate-900 border-4 border-indigo-500 rounded-full flex items-center justify-center mb-6 z-10 relative shadow-[0_0_30px_rgba(99,102,241,0.4)] mx-auto">
                                        <BookOpen size={24} className="text-white" />
                                    </div>
                                    <div className="bg-indigo-950/40 p-6 rounded-2xl border border-indigo-500/40 hover:bg-slate-800/80 transition-all h-auto md:h-[440px] overflow-y-visible md:overflow-y-auto custom-scrollbar shadow-2xl">
                                        <h4 className="text-xl font-bold text-indigo-400 mb-4 uppercase text-center md:text-left">Desarrollo</h4>
                                ...
                                {/* Aplicación */}
                                <div className="group">
                                    <div className="w-14 h-14 bg-slate-900 border-4 border-amber-500 rounded-full flex items-center justify-center mb-6 z-10 relative shadow-[0_0_30px_rgba(245,158,11,0.4)] mx-auto">
                                        <Target size={24} className="text-white" />
                                    </div>
                                    <div className="bg-slate-900/60 p-6 rounded-2xl border border-amber-500/30 hover:bg-slate-800/80 transition-all h-auto md:h-[400px] overflow-y-visible md:overflow-y-auto custom-scrollbar">
                                        <h4 className="text-xl font-bold text-amber-400 mb-4 uppercase text-center md:text-left">Aplicación</h4>
                                        <p className="text-lg text-slate-300 whitespace-pre-line leading-relaxed">
                                ...
                                <div className="group md:-mt-8">
                                    <div className="w-14 h-14 bg-slate-900 border-4 border-rose-500 rounded-full flex items-center justify-center mb-6 z-10 relative shadow-[0_0_30px_rgba(244,63,94,0.4)] mx-auto">
                                        <Flag size={24} className="text-white" />
                                    </div>
                                    <div className="bg-slate-900/60 p-6 rounded-2xl border border-rose-500/30 hover:bg-slate-800/80 transition-all h-auto md:h-[440px] overflow-y-visible md:overflow-y-auto custom-scrollbar">
                                        <h4 className="text-xl font-bold text-rose-400 mb-4 uppercase text-center md:text-left">Cierre</h4>
                                        <p className="text-lg text-slate-300 whitespace-pre-line leading-relaxed">
